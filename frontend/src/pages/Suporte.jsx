  ...
  const handleSendChatMessage = async () => {
    ...
    if (!token) {
      setChatMessages(prev => [...prev, {
        type: 'bot',
        text: 'Você precisa estar logado para usar o chat. Faça login primeiro.',
        timestamp: new Date(),
      }])
      setChatInput('')
      return
    ...
    if (!ticketId) {
      try {
        ...
        if (ticket?._id) {
          ...
          setChatMessages(prev => [...prev, {
            type: 'bot',
            text: 'Seu chamado foi criado. Um farmacêutico irá responder em breve.',
            timestamp: new Date(),
          }])
        }
      } catch (err) {
  ...
  return (
    <div className="page-shell py-8 sm:py-12">
      <div className="text-center mb-12">
        <h1 className="section-title mb-3">Centro de Suporte</h1>
        <p className="text-gray-600 text-base sm:text-lg">Estamos aqui para ajudar você 24/7</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
        <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6 text-center">
          ...
          <button
            ...
            className="w-full bg-blue-500 text-white px-6 py-2.5 rounded-lg hover:bg-blue-600 transition sm:w-auto"
          >
        ...
        <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6 text-center">
          ...
          <button
            ...
            className="w-full bg-green-500 text-white px-6 py-2.5 rounded-lg hover:bg-green-600 transition sm:w-auto"
          >
        ...
        <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6 text-center">
          ...
          <a
            href="tel:0800123456"
            className="inline-block w-full bg-purple-500 text-white px-6 py-2.5 rounded-lg hover:bg-purple-600 transition sm:w-auto"
          >
            0800 123 456
          </a>
        </div>
      ...
      {showChat && (
        <div className="bg-white rounded-xl shadow-sm p-4 sm:p-6 mb-12 max-w-2xl mx-auto border border-gray-200">
          <div className="h-96 overflow-y-auto border rounded-lg p-4 bg-gray-50 mb-4 space-y-4">
            {chatMessages.map((msg, index) => (
              <div key={index}>
                {msg.type === 'bot' ? (
                  <div className="flex justify-start mb-2">
                    <div className="bg-blue-100 text-gray-800 rounded-lg rounded-tl-none px-4 py-3 max-w-[85%] sm:max-w-sm">
                  ...
                  <div className="flex justify-end mb-2">
                    <div className="bg-green-500 text-white rounded-lg rounded-tr-none px-4 py-3 max-w-[85%] sm:max-w-sm">
          ...
          {selectedOption && (
            <div className="mb-4 flex flex-col gap-2 px-4 py-3 bg-gray-50 rounded-lg border border-gray-200 sm:flex-row sm:items-center sm:justify-between">
      ...
      {showEmailForm && (
        <div className="max-w-2xl mx-auto bg-white rounded-xl shadow-sm p-5 sm:p-8 mb-12 border border-green-200">
          <div className="flex items-start justify-between gap-4 mb-6">
            <h2 className="text-xl sm:text-2xl font-bold">Envie-nos uma mensagem</h2>
            <button
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:gap-4">
              <button
                type="submit"
                disabled={loading}
                className="flex-1 bg-green-500 hover:bg-green-600 disabled:bg-gray-400 text-white font-bold py-2.5 rounded-lg transition flex items-center justify-center gap-2"
              >
                <Send size={18} />
